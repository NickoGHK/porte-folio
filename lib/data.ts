...
export const projets = [
  {
    titre: "Peel and Stick — projet de fin d'études",
    desc: "Projet de fin d'études : une application fictive de carvertising mettant en relation trois acteurs — les marques qui financent une campagne, les agences de signalétique qui posent le covering, et les automobilistes qui prêtent leur voiture comme support publicitaire contre rémunération. Identité de marque complète, déclinée jusqu'aux livrables d'affichage.",
    tags: ["Projet de fin d'études", "Identité de marque", "Application"],
    bg: "radial-gradient(circle at 32% 28%, #B8F0D8 0%, #38BA82 38%, #1E6A4A 68%, #0E2E22 100%)",
    cover: img("peel-and-stick/mockup-covering-voiture.jpg", "Peel and Stick — covering voiture"),
    gallery: [
      vid("peel-and-stick/demo-site.mp4", "peel-and-stick/mockup-facade-urbaine.jpg"),
      vid("peel-and-stick/demo-app.mp4", "peel-and-stick/mockup-peage.jpg"),
      img("peel-and-stick/mockup-covering-voiture.jpg", "Mockup — covering voiture"),
      img("peel-and-stick/mockup-facade-urbaine.jpg", "Mockup — affichage grand format en façade"),
      img("peel-and-stick/mockup-peage.jpg", "Mockup — panneau péage autoroutier"),
      img("peel-and-stick/mockup-bache-periph.jpg", "Mockup — bâche périphérique"),
      img("peel-and-stick/mockup-parking.jpg", "Mockup — caisson lumineux parking"),
      img("peel-and-stick/mockup-affiche-collee.jpg", "Mockup — affiche collée urbaine"),
      img("peel-and-stick/affiche-4m2.jpg", "Affiche 4m²"),
      img("peel-and-stick/affiche-1.jpg", "Affiche — variante 1"),
      img("peel-and-stick/affiche-2.jpg", "Affiche — variante 2"),
      ...
      img("peel-and-stick/carte-visite-verso.jpg", "Carte de visite — verso"),
      img("peel-and-stick/sticker.jpg", "Sticker voiture"),
      img("peel-and-stick/reseaux-1.jpg", "Réseaux sociaux — visuel 1"),
      img("peel-and-stick/reseaux-2.jpg", "Réseaux sociaux — visuel 2"),
      vid("peel-and-stick/motion.mp4", "peel-and-stick/sticker.jpg"),
    ],
  },
  {
    titre: "Stage EPNAK — supports de communication",
    desc: "Huit semaines comme assistant graphiste au service communication de la direction territoriale Sud-Ouest de l'EPNAK, un établissement public médico-social accompagnant enfants et adultes en situation de handicap : signalétique et trombinoscope d'un établissement, plaquettes territoriales, catalogues de formation, template de conférence et affiches événementielles.",
    tags: ["Stage", "Communication institutionnelle", "Print"],
    ...
    gallery: [
      ...
      img("stage-epnak/jsh-affichette-2.jpg", "Journée Sport Handicap — affichette, variante"),
      ...
      img("stage-epnak/muret-2.jpg", "Plaquette territoriale Muret — verso"),
      img("stage-epnak/catalogue-limoges.jpg", "Catalogue des dispositifs — Limoges"),
      img("stage-epnak/fiche-graphiste.jpg", "Fiche formation RNCP — Titre professionnel graphiste"),
    ],
  },
  {
