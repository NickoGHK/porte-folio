...
export const projets = [
  {
    ...
    cover: img("peel-and-stick/logo.jpg", "Peel and Stick — logo"),
    gallery: [
      img("peel-and-stick/logo.jpg", "Logo — Peel and Stick"),
      img("peel-and-stick/logo-usages.jpg", "Usages du logo et zone de sécurité"),
      img("peel-and-stick/traitement-photo.jpg", "Traitement photographique de la marque"),
      vid("peel-and-stick/demo-site.mp4", "peel-and-stick/mockup-abribus.jpg"),
      vid("peel-and-stick/demo-app.mp4", "peel-and-stick/mockup-cartes-visite.jpg"),
      img("peel-and-stick/mockup-abribus.jpg", "Affiche 2m² — mise en situation abribus"),
      img("peel-and-stick/mockup-panneau.jpg", "Affiche — mise en situation panneau urbain"),
      ...
      img("peel-and-stick/papier-marque.jpg", "Papier à en-tête"),
  ...
  },
  {
    ...
    gallery: [
      ...
      img("stage-epnak/catalogue-bordeaux.jpg", "Catalogue des dispositifs — Bordeaux"),
